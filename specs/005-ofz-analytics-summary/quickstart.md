...
3. Выбрать диапазон с уже прогретыми данными, например последние 30-90
   торговых дней.
4. Нажать `Загрузить`.
5. Проверить, что в блоке summary видны 3-7 выводов с числами: даты, оборот,
   сделки, score, spread/liquidity или yield move.
...
8. Выбрать вывод, связанный с выпуском или датой, и проверить drill-down к
   существующей детализации выпуска/heatmap/table context.
